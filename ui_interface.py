...
"}")
        ...
        icon.addFile(u":/icons/icons/feather/align-left.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        ...
        self.horizontalLayout_9.addWidget(self.open_close_side_bar_btn, 0, PySide2.QtGui.Qt.AlignLeft)


        self.horizontalLayout_4.addWidget(self.frame, 0, PySide2.QtGui.Qt.AlignLeft)

        self.app_logo = QLabel(self.header_left_frame)
        self.app_logo.setObjectName(u"app_logo")
        self.app_logo.setPixmap(PySide2.QtGui.QPixmap(u":/icons/icons/feather/airplay.svg"))

        self.horizontalLayout_4.addWidget(self.app_logo, 0, PySide2.QtGui.Qt.AlignRight)

        self.label = QLabel(self.header_left_frame)
        self.label.setObjectName(u"label")
        font1 = PySide2.QtGui.QFont()
        ...
        self.label.setAlignment(PySide2.QtGui.Qt.AlignCenter)
        ...
        icon1 = PySide2.QtGui.QIcon()
        icon1.addFile(u":/icons/icons/cil-minus.png", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        ...
        icon2 = PySide2.QtGui.QIcon()
        icon2.addFile(u":/icons/icons/cil-window-restore.png", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        ...
        icon3 = PySide2.QtGui.QIcon()
        icon3.addFile(u":/icons/icons/cil-x.png", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        ...
        self.horizontalLayout_2.addWidget(self.header_right_frame, 0, PySide2.QtGui.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.label_5, 1, 1, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon4 = PySide2.QtGui.QIcon()
        icon4.addFile(u":/icons/icons/feather/cpu.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.cpu_page_btn.setIcon(icon4)
        self.cpu_page_btn.setIconSize(QSize(32, 32))
        self.cpu_page_btn.setFlat(True)

        self.gridLayout.addWidget(self.cpu_page_btn, 0, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)

        self.label_20 = QLabel(self.left_side_menu)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setMargin(5)

        self.gridLayout.addWidget(self.label_20, 4, 1, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon5 = PySide2.QtGui.QIcon()
        icon5.addFile(u":/icons/icons/feather/disc.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.storage_btn.setIcon(icon5)
        self.storage_btn.setIconSize(QSize(32, 32))
        self.storage_btn.setFlat(True)

        self.gridLayout.addWidget(self.storage_btn, 4, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon6 = PySide2.QtGui.QIcon()
        icon6.addFile(u":/icons/icons/feather/battery-charging.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.battery_page_btn.setIcon(icon6)
        self.battery_page_btn.setIconSize(QSize(32, 32))
        self.battery_page_btn.setFlat(True)

        self.gridLayout.addWidget(self.battery_page_btn, 1, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)

        self.label_23 = QLabel(self.left_side_menu)
        self.label_23.setObjectName(u"label_23")
        self.label_23.setMargin(5)

        self.gridLayout.addWidget(self.label_23, 5, 1, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon7 = PySide2.QtGui.QIcon()
        icon7.addFile(u":/icons/icons/feather/activity.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.activity_btn.setIcon(icon7)
        self.activity_btn.setIconSize(QSize(32, 32))
        self.activity_btn.setFlat(True)

        self.gridLayout.addWidget(self.activity_btn, 3, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon8 = PySide2.QtGui.QIcon()
        icon8.addFile(u":/icons/icons/feather/monitor.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.system_inf_page_btn, 2, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        self.gridLayout.addWidget(self.label_19, 3, 1, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon9 = PySide2.QtGui.QIcon()
        icon9.addFile(u":/icons/icons/feather/thermometer.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.sensors_page_btn.setIcon(icon9)
        self.sensors_page_btn.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.sensors_page_btn, 5, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        self.gridLayout.addWidget(self.label_3, 0, 1, 1, 1, PySide2.QtGui.Qt.AlignLeft)
        ...
        icon10 = PySide2.QtGui.QIcon()
        icon10.addFile(u":/icons/icons/feather/wifi.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.networks_page_button.setIcon(icon10)
        self.networks_page_button.setIconSize(QSize(32, 32))

        self.gridLayout.addWidget(self.networks_page_button, 6, 0, 1, 1, PySide2.QtGui.Qt.AlignLeft)

        self.label_41 = QLabel(self.left_side_menu)
        self.label_41.setObjectName(u"label_41")
        self.label_41.setMargin(4)

        self.gridLayout.addWidget(self.label_41, 6, 1, 1, 1, PySide2.QtGui.Qt.AlignLeft)


        self.verticalLayout_2.addWidget(self.left_side_menu, 0, PySide2.QtGui.Qt.AlignLeft | PySide2.QtGui.Qt.AlignTop)


        self.horizontalLayout.addWidget(self.side_menu_frame, 0, PySide2.QtGui.Qt.AlignLeft)
...
"border-radius: 10px;")
        ...
        self.horizontalLayout_8.addWidget(self.activity_search, 0, PySide2.QtGui.Qt.AlignRight)

        self.pushButton_5 = QPushButton(self.frame_4)
        self.pushButton_5.setObjectName(u"pushButton_5")
        icon11 = PySide2.QtGui.QIcon()
        icon11.addFile(u":/icons/icons/feather/search.svg", QSize(), PySide2.QtGui.QIcon.Normal, PySide2.QtGui.QIcon.Off)
        self.pushButton_5.setIcon(icon11)
        self.pushButton_5.setIconSize(QSize(16, 16))

        self.horizontalLayout_8.addWidget(self.pushButton_5, 0, PySide2.QtGui.Qt.AlignRight)


        self.horizontalLayout_7.addWidget(self.frame_4, 0, PySide2.QtGui.Qt.AlignRight)
        ...
        self.sensorTable.setGridStyle(PySide2.QtGui.Qt.CustomDashLine)
        ...
        self.gridLayout_3.addWidget(self.stackedWidget, 1, 0, 1, 1, PySide2.QtGui.Qt.AlignTop)


        self.horizontalLayout.addWidget(self.nain_body_cont_frame, 0, PySide2.QtGui.Qt.AlignTop)
        ...
        self.gridLayout_10.addWidget(self.label_32, 2, 1, 1, 1, PySide2.QtGui.Qt.AlignTop)
        ...
        self.label_31.setTextFormat(PySide2.QtGui.Qt.RichText)
        self.label_31.setPixmap(PySide2.QtGui.QPixmap("facebook.svg"))
        ...
        self.gridLayout_10.addWidget(self.label_31, 2, 0, 1, 1, PySide2.QtGui.Qt.AlignTop)

        self.label_33 = QLabel(self.frame_7)
        self.label_33.setObjectName(u"label_33")
        self.label_33.setPixmap(PySide2.QtGui.QPixmap(u":/icons/icons/feather/github.svg"))

        self.gridLayout_10.addWidget(self.label_33, 3, 0, 1, 1)

        self.label_43 = QLabel(self.frame_7)
        self.label_43.setObjectName(u"label_43")
        self.label_43.setPixmap(PySide2.QtGui.QPixmap(u":/icons/icons/feather/twitter.svg"))
        ...
        self.gridLayout_9.addWidget(self.frame_7, 2, 1, 1, 1, PySide2.QtGui.Qt.AlignTop)
        ...
        self.horizontalLayout_5.addWidget(self.help_btn, 0, PySide2.QtGui.Qt.AlignRight)
        ...
        self.horizontalLayout_5.addWidget(self.size_grip, 0, PySide2.QtGui.Qt.AlignBottom)
